...
public class RegionMenuBuildingSceneLoader : MonoBehaviour {
    public GameObject NodeTemplate;
    public Transform Background;
    public float Offset, NodeWidth, NodeHeight;
    public int AmountY = 2;

    private static RegionMenuBuildingSceneLoader _Instance;
    ...
    public void Load()
    {
        ...
        var queue = Player.Instance.SelectedRegion.GetBuildQueue();
        int x = 0; int y = 0;
